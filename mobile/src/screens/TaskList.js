...
class TaskList extends Component {
    ...
    loadTasks = async () => {
        try{
            const maxDate = moment()
                ...
                .format('DD-MM-YY 23:59:59'); //Padrão da data do oracle
    ...
    addTask = async (newTask) => {
        ...
        newTask.date = moment(newTask.date).format('DD-MM-YY 23:59:59');
        try{
            ...
            <View style={styles.container}>
                <AddTask isVisible ={this.state.showAddTask}
                    ...
                    <ImageBackground source={this.getImage()} style={styles.background}>
                        ...
                        <View style={styles.iconBar}>
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.openDrawer()}>
                                <Icon name='menu'
                                        size={20} color={this.props.drawerIconColor}/>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={this.toggleFilter}>
                                <Icon name={this.state.showDoneTasks ? 'eye' : 'eye-off'}
                                        size={20} color={this.props.visibleTasksIconColor}/>
                            </TouchableOpacity>
                        </View>
                    ...
                    {!this.state.visibleTasks.length
                     ?
                      <View style={styles.emptyTaskListText}>
                          <Text >Ótimo! Você não tem tarefas pendentes!</Text> 
